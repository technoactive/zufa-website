...
function keyFacts(): string {
  return line([
    ...
    `- **Features:** fully licensed (Lebanese wines, arak, cocktails), al fresco patio, free Wi-Fi, vegetarian & vegan friendly, allergen information on every dish, corkage-free Mondays.`,
...
export function buildLlmsFullTxt(): string {
  ...
  return line([
    ...
    `- Direct online ordering on ${absoluteUrl("/takeaway")}#order-online (20% off the first order placed on that form; not valid on Deliveroo, Uber Eats or Just Eat).`,
