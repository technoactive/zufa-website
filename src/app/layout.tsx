  ...
  return (
    <html lang={site.language} className={`${cormorant.variable} ${montserrat.variable} no-js`} data-scroll-behavior="smooth" suppressHydrationWarning>
      ...
      <body id="top" className="flex min-h-dvh flex-col">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-full focus:bg-gold-deep focus:px-5 focus:py-3 focus:text-sm focus:font-bold focus:text-ink"
        >
          Skip to content
        </a>
        <Header />
