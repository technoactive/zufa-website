...
const base =
  "group/btn relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-sans text-[0.8125rem] font-semibold uppercase tracking-[0.16em] transition-[background-color,color,border-color,transform,box-shadow] duration-300 ease-(--ease-out-expo) disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-offset-4";

const variants: Record<Variant, string> = {
  primary: "bg-gold text-ink shadow-glow hover:bg-cream hover:shadow-none active:translate-y-px",
  secondary: "border border-gold/60 text-gold hover:border-gold hover:bg-gold hover:text-ink active:translate-y-px",
