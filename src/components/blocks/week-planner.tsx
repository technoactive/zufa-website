                ...
                {items.map((item) => (
                  <li key={item.id}>
                    <Link
                      ...
                      className="group/chip block rounded-xl border border-gold/20 bg-gold/[0.06] px-3 py-2.5 text-left transition-colors duration-300 hover:border-cream hover:bg-cream"
                    >
