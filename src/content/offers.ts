...
export const offers: readonly Offer[] = [
  {
    id: "breakfast",
    kind: "offer",
    title: "Breakfast, Wednesday to Sunday",
    short: "Breakfast",
    headline: "Breakfast from 8am, Wednesday to Sunday",
    description:
      "We open at 8am from Wednesday through to Sunday. Manakish from the oven, Lebanese eggs, foul, labneh and sharing platters — or eggs Benedict, pain perdu and pancakes. Breakfast is served until midday, then the rest of the kitchen takes over.",
    when: breakfastService.label,
    days: breakfastService.days,
    hours: "8am – midday",
    stat: { value: "8am", label: "Wednesday to Sunday" },
